...
<head>
  ...
  <!-- Fonts -->
  <link href="https://fonts.googleapis.com/css2?family=Inter:wght@300;400;500;600;700&family=DM+Sans:wght@400;600;700&display=swap" rel="stylesheet">
  ...
  <style>
    ...
    .header {
      margin-top: 48px;
      background: linear-gradient(145deg, rgba(124,156,255,.15), rgba(154,124,255,.10) 60%, rgba(14,17,22,0) 100%);
    ...
    .main-description p { color: var(--muted); font-size: 16px; }

    .main-description .pill {
    ...
    .navbar-list { list-style: none; padding: 0; margin: 0; display: inline-flex; gap: 4px; }
    ...
    .button:hover { transform: translateY(-1px); filter: brightness(1.02); text-decoration: none; }
    .button:active { transform: translateY(0); }

    .logo-image { height: 1em; width: auto; }

    /* Highlight / Callout */
    .highlight-box {
      width: 100%;
      background: linear-gradient(145deg, rgba(126,240,193,.12), rgba(124,156,255,.09));
      padding: 16px 18px;
      border: 1px solid var(--border);
      border-radius: var(--radius);
      margin-top: 20px;
    ...
    .highlight-box .section-title { color: var(--success); font-size: 1.15em; font-weight: 700; }
    .highlight-box span[style*="color:blue"] { color: var(--accent) !important; }
    ...
    /* Lists */
    ul { padding-left: 18px; margin: 0; list-style-position: outside; }
    li { margin: 6px 0; color: var(--text); }

    /* Papers */
    .paper { padding: 14px 0; }
    .paper .title { font-weight: 600; color: var(--text); }
    .paper i { color: var(--muted); }
    .paper .button { margin-left: 6px; margin-bottom: 6px; }
    ...
    /* News read-more / cite toggles */
    #more_news, #more_cite001, #more_cite_002, #more_cite_003, #more_cite_004, #more_cite_005, #more_cite_006, #more_cite_007, #more_cite_008 { display: none; }
    ...
    /* Link icon row in header */
    .socials span { margin-right: 10px; font-size: 20px; color: var(--text); }
    .socials span:hover { color: var(--accent); cursor: pointer; }

    /* Fix any inline legacy colors for readability on dark theme */
    [style*="color:blue"] { color: var(--accent) !important; }
    [style*="color:red"] { color: var(--danger) !important; }

    /* Responsive tweaks */
    @media (max-width: 768px) {
      .round-image { width: 160px; height: 160px; border-radius: 18px; }
      .main-description h1 { font-size: 34px; }
      .navbar { top: 8px; }
    }
  </style>

  <!-- Your original custom CSS (kept last if you want to override) -->
    ...
    <section class="header">
      <div class="row">
        ...
        <div class="nine columns main-description">
          ...
          <p><strong>Email:</strong> ssaha2@umbc.edu
             <strong>Location:</strong> ITE 338, UMBC, Baltimore, MD 21250
          </p>
          <p class="pill-row" style="color:blue;"> Computer Vision | Interactive Video Retrieval | Visual Reasoning | Vision and Language</p>
          <p class="socials">
    ...
    <nav class="navbar">
      <div class="container">
        <ul class="navbar-list">
          ...
          <li class="navbar-item"><a class="navbar-link" href="/index.html#academic-service">Academic Service</a></li>
          <li class="navbar-item"><a class="navbar-link" href="/index.html#collaborators">Collaborators</a></li>
        </ul>
      </div>
    </nav>
    ...
    pages     = {620-629}
          ...
          <script>
            function cite_008_func() {
              ...
              if (moreText.style.display === "none") { moreText.style.display = "inline"; btnText.innerHTML = "hide"; }
              else { moreText.style.display = "none"; btnText.innerHTML = "cite"; }
            }
          </script>
        </p>
      </div>
...
@inproceedings{saha2018total,
    ...
    <div class="footer">
      <div class="row">
        <div class="four columns">Sourajit Saha</div>
        <div class="four columns">Last updated 08/12/2025</div>
        <div class="four columns socials">
          <span onclick="window.open('https://github.com/sourajitcs')" style="cursor: pointer"><i class="fa fa-github" aria-hidden="true"></i></span>
          <span onclick="window.open('https://www.linkedin.com/in/sourajitcs/')" style="cursor: pointer"><i class="fa fa-linkedin-square" aria-hidden="true"></i></span>
          <span onclick="window.open('https://twitter.com/sourajitCS')" style="cursor: pointer"><i class="fa fa-twitter" aria-hidden="true"></i></span>
        </div>
      </div>
    </div>
